#!/bin/bash
# LAL Commerce OS — Aylik Kar Trendi grafik redesign
# Repo kok dizininde calistir: bash uygula_grafik_redesign.sh
set -e
...
{% block content %}
  ...
  <div id="summary-content" class="is-hidden">
    ...
    <div class="panel">
      <div class="mpc-head">
        <div>
          <h2>Aylık Kâr Trendi</h2>
          <p class="panel-note">Verinin başlangıcından bugüne, ay ay ciro, brüt kâr ve net kâr. Bu grafik yukarıdaki tarih filtresinden bağımsızdır — her zaman tüm geçmişi gösterir.</p>
        </div>
...
git commit -m "redesign(gosterge-paneli): aylik kar trendi grafigini LAL tasarim dilinde yeniden kur - dual axis, hover tooltip, metric selector, theme-aware"
git push
